      ...
      <section className="relative overflow-hidden px-6 pb-16 pt-16 md:pb-24 md:pt-32">
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            <Link
              href="/signup"
              className="w-full rounded-xl bg-brand-gradient px-8 py-4 text-center font-semibold text-black transition hover:opacity-90 sm:w-64"
            >
              Start saving free
            </Link>
            <a
              href="https://apps.apple.com/app/id6762589970"
              className="inline-flex w-full items-center justify-center gap-3 rounded-xl border border-white/15 bg-white/5 px-7 py-3.5 transition hover:bg-white/10 sm:w-64"
            >
